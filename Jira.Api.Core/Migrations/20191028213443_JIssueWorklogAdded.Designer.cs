...
namespace Jira.Core.Migrations
{
    ...
    [Migration("20191028213443_JIssueWorklogAdded")]
    partial class JIssueWorklogAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jira.Core.Data.Entities.JIssueWorklog", b =>
                {
                    b.Property<long>("Id");
                    ...
                    b.Property<string>("UpdateAuthorKey");
                    ...
                    b.HasIndex("UpdateAuthorKey");

                    b.ToTable("JiraIssueWorklogs");
                });
            ...
            modelBuilder.Entity("Jira.Core.Data.Entities.JIssueWorklog", b =>
                {
                    b.HasOne("Jira.Core.Data.Entities.JUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorKey");

                    b.HasOne("Jira.Core.Data.Entities.JUser", "UpdateAuthor")
                        .WithMany()
                        .HasForeignKey("UpdateAuthorKey");
                });
